...
public abstract class Customer {
	...
	Customer(String nameIn, Grade gradeIn, discountMethod discountMethod){
		this.name = nameIn;
		this.rank = gradeIn;
...
class Web extends Customer {

	Web(String nameIn, Grade gradeIn, discountMethod discountMethod) {
		super(nameIn, gradeIn, discountMethod);
	}
...
class Mobile extends Customer {
	Mobile(String nameIn, Grade gradeIn, discountMethod discountMethod) {
		super(nameIn, gradeIn, discountMethod);
	}
